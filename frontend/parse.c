            ...
            if (*token == '-') { /* GNU style */
                ...
                while ((c = *token++) != '\0') {
                    ...
                    case 'q':
                        ...
                        break;
                        case '9':
                        (void) lame_set_quality(gfp, 19);
                        break;
                        case '8':
                        (void) lame_set_quality(gfp, 18);
                        break;
                        case '7':
                        (void) lame_set_quality(gfp, 17);
                        break;
                        case '6':
                        (void) lame_set_quality(gfp, 16);
                        break;
                        case '5':
	                ...
	                case '2':
                        ...
                        break;
                        case '1':
                        (void) lame_set_quality(gfp, 11);
                        break;
			case '0':
                        (void) lame_set_quality(gfp, 10);
                        break;	    
                    case 'f':
